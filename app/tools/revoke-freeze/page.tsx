      ...
      <div className="page-wrap page-wrap--narrow">
        ...
        {txState === "confirmed" ? (
          <div className="tx-success lp-card">
            ...
            <p className="tx-success-label">Freeze authority revoked for {token.toUpperCase()}</p>
          ...
          <>
            <div className="lp-card burn-card">
              ...
              <div className="revoke-info-row">
                <span className="revoke-info-label">Current freeze authority</span>
              ...
              <div className="burn-warning">
                ...
                <div>
                  ...
                  This is often expected by holders and DEXs as a trust signal.
                </div>
              </div>

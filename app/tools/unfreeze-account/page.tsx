      ...
      <div className="page-wrap page-wrap--narrow">
        <div className="tool-header">
          ...
          <p className="page-sub">
            Restore transfer ability to frozen token accounts. Requires freeze authority on the token.
          </p>
        ...
        {txState === "confirmed" ? (
          <div className="tx-success lp-card">
            ...
            <p className="tx-success-label">{validAddresses.length} account{validAddresses.length !== 1 ? "s" : ""} unfrozen</p>
            <p className="burn-remaining">Those wallets can now transfer {token.toUpperCase()} again.</p>
          ...
          <>
            <div className="lp-card burn-card">
              ...
              <div className="burn-warning">
                ...
                <div>
                  Only addresses that are currently frozen can be unfrozen.
                  Submitting an already-active address will fail on-chain and you will still be charged the platform fee.
                </div>
              </div>
            </div>
            ...
            <div className="wizard-actions">
              {txState !== "idle" ? (
                ...
                >
                  Unfreeze {validAddresses.length > 0 ? `${validAddresses.length} Account${validAddresses.length !== 1 ? "s" : ""}` : "Accounts"}
                </button>
              )}
            </div>
          </>

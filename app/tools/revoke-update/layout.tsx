...
const TITLE = "Revoke Update Authority on a Solana Token — FORGE";
const DESCRIPTION =
  ...
  return (
    <>
      ...
      <JsonLdHowTo
        ...
        steps={[
          { name: "Open the tool", text: "Go to forge.solana.tools/tools/revoke-update and connect the wallet that holds the update authority." },
          { name: "Enter your mint address", text: "Paste the token's mint address. FORGE verifies on-chain that your wallet is the current update authority." },
